...
//        dsc.setDriverName("com.mysql.jdbc.Driver");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/medical_partmyself?useUnicode=true&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"blood_inbound","blood_outbound"}); // 需要生成的表.如果需要生成所有的, 注释掉此行就可以
        ...
        pc.setParent("com.formal.partmyself");// 自定义包路径
